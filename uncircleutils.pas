...
type
  ...
  public
    ...
    class function GetCircleFromPathParts(const intfList: IPathPartList;
      const iCircleID: integer): ICircle;
...
class function TCircleUtils.GetCircleFromPathParts(const intfList: IPathPartList;
  const iCircleID: integer): ICircle;
var
  i: integer;
begin
